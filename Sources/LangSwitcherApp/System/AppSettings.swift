...
extension Notification.Name {
    static let langSwitcherSettingsChanged = Notification.Name("LangSwitcherSettingsChanged")
}
...
final class AppSettings: ObservableObject {
    ...
    @Published var neverConvert: String { didSet { persist(Key.neverConvert, neverConvert) } }
    ...
    private func persist(_ key: String, _ value: Any) {
        ...
        NotificationCenter.default.post(name: .langSwitcherSettingsChanged, object: self)
    }
}
